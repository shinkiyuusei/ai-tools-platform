...
def build_enhanced_system_prompt(
    ...
    if is_swapped:
        ...
        tail_instruction = (
            f"以【{perspective_name}】的第一人称视角展示开场。如果初始剧情中包含原默认主人公视角的描写，请自动从{perspective_name}的角度重新诠释场景——你看到什么、听到什么、感受到什么。从环境氛围入手，让角色依次登场，每个角色亮相时给出具体的对话、神态和身体语言。结尾给出明确的抉择点。"
        )
    else:
        ...
        tail_instruction = "请以【初始剧情】为起点，用沉浸式的第一人称叙事向玩家展示开场。从环境氛围（光线、气味、温度、声音）入手，让角色依次登场，每个角色亮相时给出具体的对话、神态和身体语言。结尾给出明确的抉择点。如果模板中没有初始剧情，请根据世界观设定和角色设定，自行构建一个引人入胜的开场。"
